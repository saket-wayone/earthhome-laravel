...
function submitForm(formData) {
    ...
    var formId = formData.attr('id');  // This gets the form's ID
    var method ='POST';  // Use PUT for editing, POST for creating
    var csrfToken = $('meta[name="csrf-token"]').attr('content');



    $.ajax({
        method: method,  // Use the dynamic method (POST/PUT)
...
function confirmDelete(id, type) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: '/admin/firms/' + id, // Update the URL to your delete route
                type: 'DELETE',
                data: {
