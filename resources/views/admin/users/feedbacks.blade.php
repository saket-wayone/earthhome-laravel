    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">All Customer Feedbacks</h4>
                        ...
                        <table class="table table-bordered  mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sort="date">Name<span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Mobile <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Subject  <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Message <span class="sort-arrow">&uarr;</span></th>
                            ...
                            <tbody id="appendleads">
                                ...
                                @if(!empty($feedbacks))
                                @foreach($feedbacks as $index => $list)
