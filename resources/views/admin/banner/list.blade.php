...
<div class="row">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{route('banners.create')}}" class="btn btn-dark  btn-sm">Add new Banner </a>
                            ...
                            <table class="table align-middle table-nowrap mb-0" style="font-size: 12px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>{{++$key}}</th>
                                        <th>
                                            <a href="{{ url($list->image) }}" target="__blank">
                                                <img src="{{ url($list->image) }}" width="100" height="100">
                                            </a>
                                        </th>
                                        <td>{{$list->source ?? ''}}</td>
                                        ...
                                        <td style="align-items: end; text-align:end;">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                    <a href="{{url('admin/banners/edit',$list->id)}}" class="btn btn-sm btn-success edit-item-btn"> <i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
        ...
        <script src="{{asset('admin/js/ajax/banner.js')}}"></script>
