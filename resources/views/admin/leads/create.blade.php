...
<form action="{{ route(name: 'leads.store') }}" id="companyadmin" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="custom-multiselect">
        ...
        <div class="selected-items" id="selected-agents">
            @if(isset($selectedAgents))
            @foreach($selectedAgents as $selected)
            <div class="selected-item" data-value="{{ $selected }}">
                {{ $selected }} <span data-value="{{ $selected }}">&times;</span>
            </div>
            @endforeach
            @endif
        </div>
        ...
        <input type="hidden" name="agents" id="selected-agents-input" 
               value="{{ isset($selectedAgents) ? json_encode($selectedAgents) : '[]' }}">
    </div>
</div>
