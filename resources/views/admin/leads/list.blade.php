        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('leads.create') }}" class="btn btn-dark">Add new Project</a>
                        ...
                        <table class="table table-bordered  mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sort="date">Project id <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">User Name <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Email <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Total Amount <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Task <span class="sort-arrow">&uarr;</span></th>
                            ...
                            <tbody id="appendleads">
                                ...
                                <tr id="lead-row-{{ $list->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/task/'.$list->id) }}" class="btn btn-primary">View Task</a>
